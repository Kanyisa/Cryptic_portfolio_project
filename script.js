document.addEventListener('DOMContentLoaded', function () {
  ...
  const roles = [
    ...
    'Shopify Theme Customization Specialist',
    'Shopify Store Setups Specialist',
    'Shopify Speed Optimization and Perfomance Specialist',
  ...
  const projects = [
    {
      ...
      category: 'fullstack',
      description:
        'A full-featured light weigth Shopify Theme created with HTML, CSS, Javascript and Liquid, featuring product catalogs, Sign In Forms, and an integrated checkout process.',
    ...
    },
    {
      ...
      category: 'frontend',
      description:
        'personalizing an online stores layout, features, and branding using the built-in theme editor, apps, or code editing (Liquid/CSS/HTML) ',
      tech: ['HTML', 'CSS', 'JavaScript','Liquid'],
      features: [
        'Shopify Theme Editor (No-Code)',
        'Block-Based Layouts',
        'Block-Based Layouts',
        'App Integration',
    ...
    {
      id: 2,
      title: 'Shopify Store Setups',
      category: 'backend',
      description:
        'The foundational steps to launching an e-commerce store, involving product uploading, theme customization, payment gateway integration, and shipping configuration',
      tech: ['Account & General Settings', 'Theme Customization', 'Domain & Navigation', 'Payments & Checkout', 'Shipping & Fulfillment'],
      features: [
        'Theme Selection',
        'Payments',
        'Shipping',
    ...
    {
      id: 3,
      title: 'Shopify Speed and Optimization',
      category: 'fullstack',
      description:
        "improving a store's loading speed to enhance user experience (UX), increase conversion rates, and boost SEO rankings",
      tech: ['Image Optimization', 'Video Optimization', 'Code Minification & Cleanup'],
      features: [
        'Lazy Loading',
        'App Management',
  ...
  const experiences = [
    {
      date: '2023 - Present',
      role: 'Expert Shopify Theme Developer',
      company: 'Upwork Inc.',
      description:
        'Help clients Setup, Customize and Launch their online stores. Create fully customizable, lightwieght and fast Shopify Themes.',
    },
    {
      date: '2022 - 2022',
      role: 'Junior Shopify Theme Developer',
      company: 'LinkedIn',
      description:
        'Helped clients resolve different kinds of problems on their Shopify stores from Themes Customizations, Store Setups, and Speed Optomizations. ',
    },
    {
      date: '2020 - 2021',
      role: 'Self learning Shopify development with HTML, CSS and Javascript',
      company: 'W3schools',
      description:
        'I learned to be a Shopify Theme Developer and started fixing small bugs and layout issues voluntarily on Shopify forums.',
    },
  ];
